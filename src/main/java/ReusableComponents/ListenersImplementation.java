...
import FactoryClasses.ExtentFactory;
import FactoryClasses.ExtentReportNG;
...
public class ListenersImplementation implements ITestListener {
    ...
    public void onTestSuccess(ITestResult result) {
        ...
        ExtentFactory.getInstance().getExtent().log(Status.PASS, MarkupHelper.createLabel(result.getName(), ExtentColor.GREEN));
        ExtentFactory.getInstance().getExtent().log(Status.PASS, "Test Case: " + result.getMethod().getMethodName() + " is Passed.");
        ExtentFactory.getInstance().removeExtentObject();
    }

    public void onTestFailure(ITestResult result) {
//        test=report.createTest(result.getName()); // create new entry in th report
//        test.log(Status.FAIL, MarkupHelper.createLabel(result.getName(), ExtentColor.RED)); // send the passed information to the report with GREEN color highlighted
        ...
        ExtentFactory.getInstance().getExtent().log(Status.FAIL, MarkupHelper.createLabel(result.getName(), ExtentColor.RED));
        ...
        String screenshotPath = System.getProperty("user.dir") +
                "/Screenshots/" + result.getName() + "-" + actualDate + ".jpeg";
